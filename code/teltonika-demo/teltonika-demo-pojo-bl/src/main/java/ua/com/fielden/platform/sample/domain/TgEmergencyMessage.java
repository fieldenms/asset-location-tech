 ...
 *
 */
@CompanionObject(ITgEmergencyMessage.class)
@MapEntityTo("EMERGENCY_MESSAGES")
public class TgEmergencyMessage extends AbstractAvlMessage {
    ...
    @Observable
    public TgEmergencyMessage setMachine(final TgMachine machine) {
