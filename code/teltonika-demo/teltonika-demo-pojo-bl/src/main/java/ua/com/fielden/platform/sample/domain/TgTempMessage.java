 ...
 *
 */
@CompanionObject(ITgTempMessage.class)
@MapEntityTo("TEMP_MESSAGES")
public class TgTempMessage extends AbstractAvlMessage {
    ...
    @Observable
    public TgTempMessage setMachine(final TgMachine machine) {
