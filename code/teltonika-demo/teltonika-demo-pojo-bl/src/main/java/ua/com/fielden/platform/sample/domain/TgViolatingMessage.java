 ...
 *
 */
@CompanionObject(ITgViolatingMessage.class)
@MapEntityTo("VIOLATING_MESSAGES")
public class TgViolatingMessage extends AbstractAvlMessage {
    ...
    @Observable
    public TgViolatingMessage setMachine(final TgMachine machine) {
